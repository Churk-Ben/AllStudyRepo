...
```
Fluffy, Cat: Fluffy (Cat): purr and meow
Buddy, Dog: Buddy (Dog): bark and wag tail
R2, Robot: R2 (Robot): dance and light up
```
...
今天继续练“组合 vs 继承 vs 多态”。组合更稳、继承更灵，接口最小化与脏标记能显著降低复杂度；资源管理优先 RAII，少踩指针坑。
