...
public class PulseExample implements Model {
    ...
    public PulseExample() {
        ...
        viewports.put(Tab.CODE, new Viewport().setSize(width, height));
        viewports.put(Tab.DIFF, new Viewport().setSize(width, height));
        viewports.put(Tab.CHAT, new Viewport().setSize(width, height));
    }
